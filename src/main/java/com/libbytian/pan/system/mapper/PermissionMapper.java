...
public interface PermissionMapper extends BaseMapper<SystemPermissionModel> {
    ...
    @Select("SELECT P.permission_id AS permissionId,permission_url As permissionUrl,permission_comment AS permissionComment,permission_status As permissionstatus from \n" +
    ...
    @Insert("INSERT INTO sys_permission (permission_url,permission_comment,permission_status) VALUES(#{permissionUrl},#{permissionComment},0)")
    int add(String permissionUrl,String permissionComment);
