...
import com.libbytian.pan.system.util.FindFishStringUtil;
    ...
    public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
        ...
        public String[] getParameterValues(String name) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                needFilterValues[i] = FindFishStringUtil.cleanXSS(values[i]);
                ...
                if (parameterObj instanceof JSONObject) {
                    ...
                    for (String key : map.keySet()) {
                        ...
                        if (map.get(key) instanceof String) {
                            resultMap.put(key, FindFishStringUtil.cleanXSS(val.toString()));
                        } else {
